...
def modbus_tcp_rtu(data_in):
	...
	if (func == 1) or (func == 2):
		...
		print("No of coil bytes: ",coil_bytes)
		ser1 = serial.Serial(
		 port = com_port,
		 baudrate = 9600,
		...
		ser1.write(coil_request)
		print(list(coil_request))
		while ser1.inWaiting():
			print("Reading")
			coil_reply = list(ser1.readline())
			print(coil_reply)
			print(bin(coil_reply[3]))
		ser1.close()
