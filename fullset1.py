...
# x[0][0] = smb.read_registers(2,8,3)
# y[0][0] = meter.read_registers(2,8,3)
# time.sleep(1)

# raw_input("Keep setting B and current 3A and PRESS ENTER")
# x[1][0]= smb.read_registers(10,8,3)
# y[1][0]= meter.read_registers(2,8,3)
# time.sleep(1)

# raw_input("Keep setting B and current 15A and PRESS ENTER")
# x[1][1]= smb.read_registers(10,8,3)
# y[1][1]= meter.read_registers(2,8,3)
# time.sleep(1)

# raw_input("Keep setting A and current 15A and PRESS ENTER")
# x[0][1] = smb.read_registers(2,8,3)
# y[0][1] = meter.read_registers(2,8,3)
# time.sleep(1)

# raw_input("Keep setting A and current 30A and PRESS ENTER")
# x[0][2] = smb.read_registers(2,8,3)
# y[0][2] = meter.read_registers(2,8,3)
# time.sleep(1)

# raw_input("Keep setting B and current 30A and PRESS ENTER")
# x[1][2] = smb.read_registers(10,8,3)
# y[1][2] = meter.read_registers(2,8,3)
# time.sleep(1)
...
# md = smb.write_registers(1,16,4)
# time.sleep(1)
# cd = smb.write_registers(17,16,4)
# time.sleep(1)
# myd = smb.write_registers(33,1,4)
# time.sleep(1)
# cyd = smb.write_registers(34,1,4)

# smb.write_registers(1,md)
# smb.write_registers(17,cd)
# smb.write_registers(33,myd)
# smb.write_registers(34,cyd)
for i in range(1,17):
 smb.write_register(i, md, 0)
 time.sleep(0.2)
for i in range(17,33):
 smb.write_register(i, cd, 0)
 time.sleep(0.2)
smb.write_register(33, md, 0)
time.sleep(0.2)
smb.write_register(34, cd, 0)
time.sleep(0.2) 
print("writing done")
